                    ...
                    @if (auth()->user()->role == 'admin')
                        <div class="card info-card sales-card">
                            <div class="card-body">
                                ...
                                <form class="row g-3" action="{{ route('projects.store') }}" enctype="multipart/form-data"
                                    method="POST">
                                    @csrf
                                    ...
                                    <div class="col-12 col-lg-4">
                                        ...
                                        <input type="number"
                                            class="form-control @error('client_phone') is-invalid @enderror" id="phone"
                                            name="client_phone">
                                        @error('client_phone')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <tbody>
                                    @foreach ($projects as $item)
                                        <tr>
                                            ...
                                            @if (count($item->project_allocated_user()) > 0)
                                                <td>
                                                    @foreach ($item->project_allocated_user() as $item1)
                                                        {{ $item1 }},
                                                    @endforeach
                                                </td>
                                            @else
                                                <td>Assign Multiple User Functionality</td>
                                            @endif
                                            </td>
                                            <td><a href="{{ route('projects.edit', $item->id) }}"
